...
*(Adapta los argumentos a tu `main.py`. Si no los tienes, puedes dejarlo fijo en el script.)*
...
* [ ] Enmascarado / privacidad (blur de caras si se requiere)
